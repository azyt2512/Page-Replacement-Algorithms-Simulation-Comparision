...
var index;
	...
	$tbody = $("<tbody></tbody>");
		for ( i=0; i<row;i++)
		  ...
		  $table.append($tbody);
		  $table.appendTo($("#div1"));
		  $("#sp11").html('<p style="text-align:center">'+"<b>The no of page faults is:</b>"+"   "+'<span style="color:red">'+pf+'</span>'+'</p>')
...
var index;
	...
	$tbody = $("<tbody></tbody>");
		for ( i=0; i<row;i++)
		  ...
		  $table.append($tbody);
		  $table.appendTo($("#div2"));
		  $("#sp12").html('<p style="text-align:center">'+"<b>The no of page faults is:</b>"+"   "+'<span style="color:red">'+pf+'</span>'+'</p>')
...
var index=-9999;
	...
	$tbody = $("<tbody></tbody>");
		for ( i=0; i<row;i++)
		  ...
		  $table.append($tbody);
		  $table.appendTo($("#div3"));
		  $("#sp13").html('<p style="text-align:center">'+"<b>The no of page faults is:</b>"+"   "+'<span style="color:red">'+pf+'</span>'+'</p>')
...
$tbody = $("<tbody></tbody>");
	for ( i=0; i<row;i++)
      ...
      $table.append($tbody);
	  $table.appendTo($("#div4"));
	  $("#sp14").html('<p style="text-align:center">'+"<b>The no of page faults is:</b>"+"   "+'<span style="color:red">'+pf+'</span>'+'</p>')
...
function crt_table(flts,hits) {
	...
	line.append('<td>'+ 'Page Faults'+'</td>');$tbody.append(line);
